<section class="image-full-width" id="our-target-group">
<h2>Target Group</h2>
...
<div class="infographics-case">
    <h3>We take care of people with </h3>
  ...
  <button class="btnRounded" id="caseworker-btn">See available spots</button>
</div>
</section>
